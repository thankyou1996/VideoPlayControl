...
namespace VideoPlayControl
{
    ...
    public partial class VideoPlayWindow : UserControl
    {
        ...
        static SDK_EzvizSDK.MsgHandler callBack = new SDK_EzvizSDK.MsgHandler(SDKState.Ezvie_MsgCallback);
        ...
        {
            int intLenght = 0;
            int intResult = SDK_EzvizSDK.OpenSDK_AllocSessionEx(callBack, IntPtr.Zero, out intptrSessionID, out intLenght);
            if (CurrentVideoPlaySet.VideoRecordEnable)
            {
                //录像启用
