...
namespace VideoPlayControl.VideoRemoteBackplay
{
    public class VideoRemoteBackplay_TLi : IVIdeoRemoteBackplay
    {
        ...
        public bool FindRemoteFile(VideoRemotePlaySearchPara para)
        {
            FindRemoteFile(CurrentVideoInfo, para);
            return true;
        }


        public fileInfo[] FindRemoteFile(VideoInfo vInfo, VideoRemotePlaySearchPara para)
        {
            return FindRemoteFile1(vInfo, para);
        }


        public static fileInfo[] FindRemoteFile1(VideoInfo vInfo, VideoRemotePlaySearchPara para)
        {
            fileInfo[] result = new fileInfo[3];
